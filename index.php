...
<body>
	...
	<div id="wrap">
		...
		<section class="home-slide">
			<ul class="slides">
				<!-- SLIDER 1 -->
				<li class="slide-img-1" data-stellar-background-ratio="0.6"></li>
				<!-- SLIDER 2 -->
				<li class="slide-img-2" data-stellar-background-ratio="0.6"></li>
			</ul>
		</section>
		<!-- Content -->
				...
				<section class="portfolio light-gray-bg padding-top-70 padding-bottom-20">
					<div class="container">
						...
						<div class="text-center">
							<div class="cbp-l-filters-buttonCenter filter-style-2" id="ajax-work-filter">
								<div class="cbp-filter-item" data-filter=".ana">Pronto
		...
		<section class="testi-bg padding-top-100 padding-bottom-100">
			<div class="container">
				<div class="testi">
					<p>R-SYSTEM es una empresa con un gran capital humano y especialistas certificados en cada area de
